...
const TEKSTER = {
  nb: {
    q1: {
      ...
      helpText: "Dagpenger, friskmeldt til arbeidsformidling og enkelte andre ytelser krever at du er registrert arbeidssøker.",
    },
    ...
    q8: { category: "Kurs/utdanning/tiltak", question: "Trenger du kurs, tiltak eller omskolering for å komme i jobb?" },
  ...
  nn: {
    q1: {
      ...
      helpText: "Dagpengar, friskmeldt til arbeidsformidling og enkelte andre ytingar krev at du er registrert arbeidssøkjar.",
    },
    q2: { category: "Pengestøtte", question: "Er du permittert?" },
    q3: {
      category: "Pengestøtte",
    ...
    q8: { category: "Kurs/utdanning/tiltak", question: "Treng du kurs, tiltak eller omskolering for å komme i jobb?" },
  ...
  en: {
    q1: {
      ...
      question: "Are you receiving or applying for financial support that requires you to be registered as a job seeker?",
      helpText: "Unemployment benefits, rehabilitation work placement and certain other benefits require you to be registered as a job seeker.",
    },
    ...
    q7: { category: "Relationship to work", question: "Do you need close guidance before you can apply for or take a job?" },
    q8: { category: "Courses/education/measures", question: "Do you need courses, measures or retraining to get a job?" },
    q9: { category: "Courses/education/measures", question: "Do you need help completing or choosing an education?" },
    q10: {
      category: "Obstacles",
